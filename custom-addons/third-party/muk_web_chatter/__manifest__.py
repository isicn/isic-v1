{
    ...
    "assets": {
        "web._assets_primary_variables": [
            ("after", "web/static/src/scss/primary_variables.scss", "muk_web_chatter/static/src/scss/variables.scss"),
        ],
        "web.assets_backend": [
            "muk_web_chatter/static/src/core/**/*.*",
            "muk_web_chatter/static/src/chatter/*.scss",
            "muk_web_chatter/static/src/chatter/*.xml",
            ("after", "mail/static/src/chatter/web_portal/chatter.js", "muk_web_chatter/static/src/chatter/chatter.js"),
            ("after", "mail/static/src/core/common/composer.js", "muk_web_chatter/static/src/chatter/composer.js"),
            (
                "after",
