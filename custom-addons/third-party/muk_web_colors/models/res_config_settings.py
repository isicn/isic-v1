...
class ResConfigSettings(models.TransientModel):
    ...
    def _replace_light_color_values(self):
        variables = [{"name": field, "value": self[f"{field}_light"]} for field in self.COLOR_FIELDS]
    ...
    def _replace_dark_color_values(self):
        variables = [{"name": field, "value": self[f"{field}_dark"]} for field in self.COLOR_FIELDS]
        return self.env["muk_web_colors.color_assets_editor"].replace_color_variables_values(
