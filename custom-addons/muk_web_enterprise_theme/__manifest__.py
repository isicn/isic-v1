{
    ...
    "assets": {
        ...
        "web.assets_backend": [
            ...
            ("remove", "muk_web_enterprise_theme/static/src/webclient/home_menu/home_menu.js"),
            ("remove", "muk_web_enterprise_theme/static/src/webclient/home_menu/home_menu.xml"),
        ],
